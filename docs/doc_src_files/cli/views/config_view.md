...
- **Action [M] (Modification)** : permettre la saisie de nouvelles valeurs et demander à Python d'écrire les modifications dans le fichier `.env` sans aucune recompilation du binaire ;
